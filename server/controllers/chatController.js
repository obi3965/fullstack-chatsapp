...
//@route           POST /api/v1/user/group/chats
//@access          Protected
...
// @route   PUT /api/v1/user/chat/groupRemove
// @access  Protected
...
// @route   PUT /api/user/chat/groupadd
// @access  Protected
 ...
 // @desc    Rename Group
// @route   PUT /api/v1/user/chat/rename
// @access  Protected
